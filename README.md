...
- [NodeJs Clean Architecture API](#nodejs-clean-architecture-api)
  ...
  - [مستندات و مسیرهای API](#مستندات-و-مسیرهای-api)
  - [اعتبارسنجی و مدیریت خطا](#اعتبارسنجی-و-مدیریت-خطا)
  - [پایگاه‌داده و تراکنش‌ها](#پایگاهداده-و-تراکنشها)
  - [لاگ و اشکال‌زدایی](#لاگ-و-اشکالزدایی)
  - [مشارکت](#مشارکت)
  - [مجوز](#مجوز)
